...
namespace DG.Common.Http.Authorization.OAuth2.Exceptions
{
    ...
    public sealed class OAuthRequestNotCompletedException : Exception
    {
        ...
        /// <inheritdoc/>
        public override string Message => $"Request with state {_state} has not been completed. Please ensure {nameof(OAuthFlow.AuthorizationCallbackAsync)} has been called.";
